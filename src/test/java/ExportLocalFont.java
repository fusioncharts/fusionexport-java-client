...
public class ExportLocalFont {
    public static void main(String[] args) throws Exception {
        ...
        config.set("chartConfig", "src/test/java/export_local_font/chart-config-file.json");
        config.set("templateFilePath", "src/test/java/export_local_font/dashboard-template.html");
