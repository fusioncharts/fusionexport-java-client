...
public class SendMail {
    ...
    public static void SendEmail(String[] files) {
    	
        // Recipient's email ID needs to be mentioned.
        String to = "rahul@fusioncharts.com";

        // Sender's email ID needs to be mentioned
        String from = "rahul@fusioncharts.com";

        final String username = "rahul@fusioncharts.com";//change accordingly
        final String password = "R@hu1Kum@r";//change accordingly
